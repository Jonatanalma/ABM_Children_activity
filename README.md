...
To determine the frequency of active travel to school each agents evaluates the distance to school and street walkability index. The algorithm used by the in the model to determine frequency of active travel is based on an analysis of travel to school reported by 713 Scotish children (see results in ordered logistic regression file). 
